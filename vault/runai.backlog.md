...
1. Fix known bugs (dump from head as they come up)
2. Review end-to-end UX - make sure flows make sense for new users
3. Improve run page design
4. Work on onboarding flow
5. Test RevenueCat integration
6. Security audit
7. Get Strava approval (brand guidelines review)
